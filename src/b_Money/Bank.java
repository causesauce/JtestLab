...
public class Bank {
	private Hashtable<String, Account> accountsList = new Hashtable<String, Account>();
	private String name;
	...
	public void openAccount(String accountId) throws AccountExistsException {
		if (accountsList.containsKey(accountId)) {
			...
			accountsList.put(accountId, new Account(accountId, this.currency));
		}
	}
	 ...
	 */
	private void transfer(String fromAccount, Bank toBank, String toAccount, Money amount) throws AccountDoesNotExistException {
