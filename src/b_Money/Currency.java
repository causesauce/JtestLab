...
public class Currency {
	...
	public Integer universalValue(Integer amount) {
		...
		double convertedToGeneral = (double)amount/100*rate;
		return (int) Math.round(convertedToGeneral*100);
	}
	...
	*/
	public Integer valueInThisCurrency(Integer amount, Currency otherCurrency) {
		int otherCurrencyUniversal = otherCurrency.universalValue(amount);
		double otherCurrencyUniversalDouble = ((double)otherCurrencyUniversal) / 100;
		return (int)Math.round(otherCurrencyUniversalDouble/rate*100);
	}
}
