...
public class Money implements Comparable {
	...
	public String toString() {
		...
		int integralPart = (amount-fractionalPart)/100;
		return integralPart + "." + fractionalPart + " " + currency.getName();
	}
	...
	public Boolean equals(Money other) {
		return (Math.abs(this.universalValue() - other.universalValue() ) == 0);
	}
	...
	public Money add(Money other) {
		int total;
		if(!this.currency.getName().equals(other.getCurrency().getName()))
			total = this.amount + this.currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
		else
			total = this.amount + other.amount;
	...
	public Money sub(Money other) {
		int total = this.amount - this.currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
		return new Money(total, this.currency);
	}
	...
	/**
	 * Negate the amount of money, i.e.e  if thamount is 10.0 SEK the negation returns -10.0 SEK
